...
DataTypeLimits::DataTypeLimits(SupportedTensors input,
    ...
    : input(input),
      ...
      dynamic_reshape_input(dynamic_reshape_input),
      dynamic_reshape_new_shape(dynamic_reshape_new_shape),
      dynamic_expand_input(dynamic_expand_input),
      dynamic_expand_new_shape(dynamic_expand_new_shape),
      dynamic_slice_input(dynamic_slice_input),
      dynamic_slice_starts(dynamic_slice_starts),
      dynamic_pad_input(dynamic_pad_input),
      dynamic_pad_pads(dynamic_pad_pads),
      dynamic_split_input(dynamic_split_input),
      dynamic_split_splits(dynamic_split_splits),
