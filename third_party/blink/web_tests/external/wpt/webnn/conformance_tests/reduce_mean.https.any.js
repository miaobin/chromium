...
const reduceMeanTests = [
  ...
  //       'name': 'reduceMean',
  //       'arguments': [
  //         {'input': 'reduceMeanInput'}, {'options': {'keepDimensions':
  //         false}}
  //       ],
  //       'outputs': 'reduceMeanOutput'
  //     }],
  ...
  // {
  //   'name':
  //       'reduceMean float32 4D tensor options.axes with
  ...
  //     'expectedOutputs': {
  //       'reduceMeanOutput':
  //           {'data': [95.875], 'descriptor': {shape: [], dataType:
  //           'float16'}}
  //     }
  //   }
  // },
  ...
  //     'expectedOutputs': {
  //       'reduceMeanOutput':
  //           {'data': [40.3125], 'descriptor': {shape: [], dataType:
  //           'float16'}}
  //     }
  //   }
  // },
  ...
  //     'expectedOutputs': {
  //       'reduceMeanOutput':
  //           {'data': [-34.75], 'descriptor': {shape: [], dataType:
  //           'float16'}}
  //     }
  //   }
  // },
  ...
  //     'expectedOutputs': {
  //       'reduceMeanOutput':
  //           {'data': [48.40625], 'descriptor': {shape: [], dataType:
  //           'float16'}}
  //     }
  //   }
  // },
  ...
  // {
  //   'name':
  //       'reduceMean float16 4D tensor options.axes with
  //       options.keepDimensions=false',
  //   'graph': {
  //     'inputs': {
  //       'reduceMeanInput': {
  ...
  {
    'name':
        'reduceMean float32 3D tensor with dynamic batch dimension default options (concrete shape [2, 3, 4])',
    'graph': {
      'inputs': {
        'reduceMeanInput': {
          'data': [
            95.84498596191406,  75.6915283203125,   1.5537033081054688,
            8.80384635925293,   70.04251098632812,  13.784164428710938,
            20.01519775390625,  94.88194274902344,  25.857526779174805,
            94.14225006103516,  67.73603820800781,  16.11018180847168,
            92.21203613281250,  11.572303771972656, 52.70657730102539,
            22.469032287597656, 3.6645839214324951, 20.21892547607422,
            58.57109069824219,  28.65628433227539,  42.10725784301758,
            21.651752471923828, 14.149776458740234, 15.122945785522461
          ],
          'shape': [2, 3, 4],
          'descriptor': {shape: ['batch', 3, 4], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reduceMean',
  ...
  {
    'name':
        'reduceMean float32 4D tensor with dynamic dimensions and axes=[1, 3] (concrete shape [2, 2, 2, 3])',
    'graph': {
      'inputs': {
        'reduceMeanInput': {
          'data': [
          ...
          'shape': [2, 2, 2, 3],
          'descriptor': {shape: ['batch', 'height', 2, 3], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reduceMean',
        'arguments':
            [{'input': 'reduceMeanInput'}, {'options': {'axes': [1, 3]}}],
        'outputs': 'reduceMeanOutput'
      }],
      'expectedOutputs': {
        'reduceMeanOutput': {
          'data': [
            52.30747985839844, 45.10316848754883, 47.63759231567383,
            16.21283531188965
          ],
          'shape': [2, 2],
  ...
  {
    'name':
        'reduceMean float32 4D tensor with dynamic dimensions and axes=[1, 3] keepDimensions=true (concrete shape [2, 2, 2, 3])',
    'graph': {
      'inputs': {
        'reduceMeanInput': {
          'data': [
      ...
      'expectedOutputs': {
        'reduceMeanOutput': {
          ...
          'shape': [2, 1, 2, 1],
          'descriptor': {shape: ['batch', 1, 2, 1], dataType: 'float32'}
        }
      }
    }
  }
