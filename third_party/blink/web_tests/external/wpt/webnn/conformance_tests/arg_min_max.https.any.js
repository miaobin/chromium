    ...
    'graph': {
      'inputs': {
        'argMinInput': {
          ...
          'shape': [2, 12],
          'descriptor': {shape: ['batch', 12], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'argMin',
    ...
    'graph': {
      'inputs': {
        'argMinInput': {
          ...
          'shape': [2, 4, 3],
          'descriptor': {shape: ['batch', 'sequence', 3], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'argMin',
      ...
      'expectedOutputs': {
        'argMinOutput': {
          'data': [2, 2, 0, 0, 0, 0],
          'shape': [2, 3],
          'descriptor': {shape: ['batch', 3], dataType: 'int32'}
        }
      }
    }
  },
    ...
    'graph': {
      'inputs': {
        'argMinInput': {
          ...
          'shape': [2, 1, 4, 3],
          'descriptor': {shape: ['batch', 1, 'height', 3], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'argMin',
      ...
      'expectedOutputs': {
        'argMinOutput': {
          'data': [2, 2, 0, 0, 0, 0],
          'shape': [2, 1, 1, 3],
          'descriptor': {shape: ['batch', 1, 1, 3], dataType: 'int32'}
        }
      }
    }
  },
    ...
    'graph': {
      ...
      'expectedOutputs': {
        'argMaxOutput': {
          'data': [8, 11],
          'shape': [2],
          'descriptor': {shape: ['batch'], dataType: 'int32'}
        }
      }
    }
  },
    ...
    'graph': {
      ...
      'expectedOutputs': {
        'argMaxOutput': {
          ...
          'shape': [1, 4, 3],
          'descriptor': {shape: [1, 'sequence', 3], dataType: 'int32'}
        }
      }
    }
  },
    ...
    'graph': {
      ...
      'expectedOutputs': {
        'argMaxOutput': {
          ...
          'shape': [2, 1, 4],
          'descriptor': {shape: ['batch', 1, 'height'], dataType: 'int64'}
        }
      }
    }
  }
