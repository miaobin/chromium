...
const averagePool2dTests = [
  ...
  {
    'name': 'averagePool2d float32 4D (dynamic batch, height, width)',
    'graph': {
      'inputs': {
        'averagePool2dInput': {
          'data': [
          ...
          'descriptor':
              {shape: ['batch', 2, 'height', 'width'], dataType: 'float32'},
          'shape': [1, 2, 5, 5]
        }
      },
      'operators': [{
  ...
  {
    'name':
        'averagePool2d float32 4D (dynamic batch, height, width) global no windowDimensions',
    'graph': {
      'inputs': {
        'averagePool2dInput': {
          'data': [
      ...
      'expectedOutputs': {
        'averagePool2dOutput': {
          'data': [47.26926803588867, 44.72445297241211],
          'descriptor': {shape: ['batch', 2, 1, 1], dataType: 'float32'},
          'shape': [1, 2, 1, 1]
        }
      }
    }
