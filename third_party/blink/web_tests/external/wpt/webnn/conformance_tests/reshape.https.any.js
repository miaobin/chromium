...
const reshapeTests = [
  ...
  {
    'name': 'reshape float32 tensor to a new shape (with dynamic dimension)',
    'graph': {
      'inputs': {
        'reshapeInput': {
          'data': [
      ...
      'operators': [{
        'name': 'reshape',
        'arguments': [{'input': 'reshapeInput'}, {'newShape': ['batch', 12]}],
        'outputs': 'reshapeOutput'
      }],
      'expectedOutputs': {
        'reshapeOutput': {
  ...
  {
    'name':
        'reshape float32 tensor with two dynamic dimensions, preserving both',
    'graph': {
      'inputs': {
        'reshapeInput': {
          'data': [
          ...
          'shape': [2, 3, 4],
          'descriptor': {shape: ['batch', 'seq', 4], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reshape',
        'arguments':
            [{'input': 'reshapeInput'}, {'newShape': ['batch', 1, 'seq', 4]}],
        'outputs': 'reshapeOutput'
      }],
      'expectedOutputs': {
        'reshapeOutput': {
          ...
          'shape': [2, 1, 3, 4],
          'descriptor': {shape: ['batch', 1, 'seq', 4], dataType: 'float32'}
        }
      }
    }
  },
  {
    'name':
        'reshape float32 tensor with three dynamic dimensions, reordering them',
    'graph': {
      'inputs': {
        'reshapeInput': {
          'data': [
          ...
          'shape': [2, 3, 4],
          'descriptor':
              {shape: ['batch', 'height', 'width'], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reshape',
        'arguments': [
          {'input': 'reshapeInput'}, {'newShape': ['width', 'batch', 'height']}
        ],
        'outputs': 'reshapeOutput'
      }],
      'expectedOutputs': {
        'reshapeOutput': {
          ...
          'shape': [4, 2, 3],
          'descriptor':
              {shape: ['width', 'batch', 'height'], dataType: 'float32'}
        }
      }
    }
  },
  {
    'name': 'reshape float32 tensor with dynamic dimension from 4D to 2D',
    'graph': {
      'inputs': {
        'reshapeInput': {
          'data': [
          ...
          'shape': [2, 1, 3, 4],
          'descriptor': {shape: ['batch', 1, 3, 4], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reshape',
