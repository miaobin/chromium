    ...
    'graph': {
      'inputs': {
        'reshapeInput': {
          ...
          'shape': [2, 3, 4],
          'descriptor':
              {shape: [{name: 'batch', maxSize: 5}, 3, 4], dataType: 'float32'}
        }
      },
      'operators': [{
        'name': 'reshape',
        'arguments': [
          {'input': 'reshapeInput'},
          {'newShape': [{name: 'batch', maxSize: 5}, 12]}
        ],
        'outputs': 'reshapeOutput'
      }],
      'expectedOutputs': {
        'reshapeOutput': {
          ...
          'shape': [2, 12],
          'descriptor':
              {shape: [{name: 'batch', maxSize: 5}, 12], dataType: 'float32'}
        }
      }
    }
  },
    ...
    'graph': {
      'inputs': {
        'reshapeInput': {
          ...
          'descriptor': {
            shape:
                [{name: 'batch', maxSize: 10}, {name: 'seq', maxSize: 20}, 4],
            dataType: 'float32'
          }
        }
      },
      'operators': [{
        ...
        'arguments': [
          {'input': 'reshapeInput'}, {
            'newShape':
                [{name: 'batch', maxSize: 10}, 1, {name: 'seq', maxSize: 20}, 4]
          }
        ],
        'outputs': 'reshapeOutput'
      }],
    ...
    'graph': {
      'inputs': {
        'reshapeInput': {
          ...
          'descriptor': {
            shape: [
              {name: 'batch', maxSize: 5}, {name: 'height', maxSize: 10},
      ...
      'operators': [{
        ...
        'arguments': [
          {'input': 'reshapeInput'}, {
            'newShape': [
              {name: 'width', maxSize: 10}, {name: 'batch', maxSize: 5},
              {name: 'height', maxSize: 10}
            ]
          }
        ],
        'outputs': 'reshapeOutput'
    ...
    'graph': {
      'inputs': {
        'reshapeInput': {
          ...
          'shape': [2, 1, 3, 4],
          'descriptor': {
            shape: [{name: 'batch', maxSize: 8}, 1, 3, 4],
            dataType: 'float32'
          }
        }
      },
      'operators': [{
        ...
        'arguments': [
          {'input': 'reshapeInput'},
          {'newShape': [{name: 'batch', maxSize: 8}, 12]}
        ],
        'outputs': 'reshapeOutput'
      }],
      'expectedOutputs': {
        'reshapeOutput': {
          ...
          'shape': [2, 12],
          'descriptor':
              {shape: [{name: 'batch', maxSize: 8}, 12], dataType: 'float32'}
        }
      }
    }
  }
