...
const layerNormTests = [
  ...
  {
    'name':
        'layerNormalization float32 4D tensor with dynamic batch dimension options.axes=[2, 3]',
    'graph': {
      'inputs': {
        'layerNormInput': {
          'data': [
          ...
          'descriptor': {shape: ['N', 1, 4, 3], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
        }
      },
      'operators': [{
        'name': 'layerNormalization',
        'arguments':
            [{'input': 'layerNormInput'}, {'options': {'axes': [2, 3]}}],
        'outputs': 'layerNormOutput'
      }],
      'expectedOutputs': {
        'layerNormOutput': {
          'data': [
            -1.4057257175445557, 0.5396456122398376,  -0.21643970906734467,
            -0.9825549125671387, 0.7713913321495056,  -0.08366984874010086,
            1.4625961780548096,  -0.8138728737831116, 0.7165266871452332,
            -1.6945915222167969, 1.3408818244934082,  0.36581382155418396,
            -1.5234858989715576, 0.5162702202796936,  0.43863824009895325,
            1.0831668376922607,  -1.2419195175170898, 0.29146093130111694,
            -1.7796510457992554, -0.5852779150009155, 1.3068106174468994,
            0.10783683508634567, 1.0319640636444092,  0.35418668389320374
          ],
          'descriptor': {shape: ['N', 1, 4, 3], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
  ...
  {
    'name':
        'layerNormalization float32 4D tensor with dynamic spatial dimension options.axes=[2]',
    'graph': {
      'inputs': {
        'layerNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 1, 'H', 3], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
        }
      },
      'operators': [{
      ...
      'expectedOutputs': {
        'layerNormOutput': {
          'data': [
            -0.6012066006660461,  0.10132187604904175, -1.1129928827285767,
            -0.26228588819503784, 0.39434170722961426, -0.7543210387229919,
            1.6960537433624268,   -1.6100701093673706, 1.4073745012283325,
            -0.8325613141059875,  1.1144068241119385,  0.459939181804657,
            -0.8445013165473938,  0.6554933190345764,  -0.38561543822288513,
            1.3668763637542725,   -1.311161756515503,  -0.7422531247138977,
            -1.0618212223052979,  -0.5766634941101074, 1.7181260585784912,
            0.539446234703064,    1.2323319911956787,  -0.5902571082115173
          ],
          'descriptor': {shape: [2, 1, 'H', 3], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
        }
  ...
  {
    'name':
        'layerNormalization float32 4D tensor with dynamic dimensions non-consecutive axes',
    'graph': {
      'inputs': {
        'layerNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 'C', 4, 'W'], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
        }
      },
      'operators': [{
        'name': 'layerNormalization',
        'arguments':
            [{'input': 'layerNormInput'}, {'options': {'axes': [1, 3]}}],
        'outputs': 'layerNormOutput'
      }],
      'expectedOutputs': {
        'layerNormOutput': {
          'data': [
            -1.3049143552780151, 1.124578833580017,    0.18033546209335327,
            -1.2348167896270752, 1.2144180536270142,   0.020398767665028572,
            1.063255786895752,   -1.33916437625885,    0.27590832114219666,
            -1.3424099683761597, 1.0564990043640137,   0.28591102361679077,
            -1.4134159088134766, 0.7478359937667847,   0.6655799746513367,
            1.076416015625,      -1.3325608968734741,  0.25614482164382935,
            -1.1229339838027954, -0.18302235007286072, 1.305956482887268,
            -0.9985197186470032, 1.3665653467178345,   -0.36804553866386414
          ],
          'descriptor': {shape: [2, 'C', 4, 'W'], dataType: 'float32'},
          'shape': [2, 1, 4, 3]
        }
  ...
  {
    'name':
        'layerNormalization float32 3D tensor with dynamic dimension on axis',
    'graph': {
      'inputs': {
        'layerNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 'H', 3], dataType: 'float32'},
          'shape': [2, 3, 3]
        }
      },
      'operators': [{
      ...
      'expectedOutputs': {
        'layerNormOutput': {
          'data': [
            -1.301377534866333, 0.17130178213119507, 1.1300756931304932,
            1.1393446922302246, 0.1558758169412613, -1.2952203750610352,
            1.3358434438705444, -1.069968342781067, -0.2658749520778656,
            1.1167322397232056, 0.19308501482009888, -1.3098169565200806,
            1.1042693853378296, -1.3172757625579834, 0.21300607919692993,
            -0.6321125030517578, -0.7795370817184448, 1.4116495847702026
          ],
          'descriptor': {shape: [2, 'H', 3], dataType: 'float32'},
          'shape': [2, 3, 3]
        }
