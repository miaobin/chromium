...
promise_test(async t => {
  ...
  const inputB =
      builder.input('inputB', {dataType: 'float32', shape: ['batch', 4]});
...
promise_test(async t => {
  ...
  const builder = new MLGraphBuilder(context);
  const inputA =
      builder.input('inputA', {dataType: 'float32', shape: ['batchA', 4]});
  const inputB =
      builder.input('inputB', {dataType: 'float32', shape: ['batchB', 4]});
...
promise_test(async t => {
  ...
  const builder = new MLGraphBuilder(context);
  const inputA =
      builder.input('inputA', {dataType: 'float32', shape: ['batch', 4]});
  const inputB =
      builder.input('inputB', {dataType: 'float32', shape: ['batch', 4]});
