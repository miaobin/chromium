    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'shape': [6],
          'descriptor': {shape: ['C'], dataType: 'float32'}
        },
        'bnMean': {
          'data': [
            -7.814267635345459, -95.64129638671875, 38.15440368652344,
    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'descriptor': {shape: ['N', 6], dataType: 'float32'},
          'shape': [4, 6]
        },
        'bnMean': {
          'data': [
    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'descriptor': {shape: [4, 'C'], dataType: 'float32'},
          'shape': [4, 6]
        },
        'bnMean': {
          'data': [
    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'descriptor': {shape: [2, 'C', 4], dataType: 'float32'},
          'shape': [2, 3, 4]
        },
        'bnMean': {
          'data': [12.810380935668945, 63.13715362548828, -61.62983322143555],
    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'descriptor': {shape: [2, 'C', 4], dataType: 'float16'},
          'shape': [2, 3, 4]
        },
        'bnMean': {
          'data': [12.8125, 63.125, -61.625],
          'descriptor': {shape: ['C'], dataType: 'float16'},
          'shape': [3]
        },
        'bnVariance': {
          'data': [18.359375, 41.84375, 16.125],
    ...
    'graph': {
      'inputs': {
        'bnInput': {
          ...
          'descriptor': {shape: [2, 2, 'H', 3], dataType: 'float32'},
          'shape': [2, 2, 2, 3]
        },
        'bnMean': {
          'data': [-23.41889190673828, 60.25288772583008],
          'descriptor': {shape: ['H'], dataType: 'float32'},
          'shape': [2]
        },
        'bnVariance': {
