...
const instanceNormTests = [
  ...
  {
    'name':
        'instanceNormalization float32 4D tensor with dynamic batch dimension default options',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
          ...
          'descriptor': {shape: ['N', 3, 2, 2], dataType: 'float32'},
          'shape': [2, 3, 2, 2]
        }
      },
      'operators': [{
  ...
  {
    'name':
        'instanceNormalization float32 4D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 'C', 2, 2], dataType: 'float32'},
          'shape': [2, 3, 2, 2]
        }
      },
      'operators': [{
  ...
  {
    'name':
        'instanceNormalization float32 4D tensor with dynamic spatial dimensions default options',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 3, 'H', 'W'], dataType: 'float32'},
          'shape': [2, 3, 2, 2]
        }
      },
      'operators': [{
  ...
  {
    'name':
        'instanceNormalization float32 4D tensor with all dynamic dimensions default options',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
          ...
          'descriptor': {shape: ['N', 'C', 'H', 'W'], dataType: 'float32'},
          'shape': [2, 3, 2, 2]
        }
      },
      'operators': [{
  ...
  {
    'name':
        'instanceNormalization float16 4D tensor with dynamic channel dimension default options',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
          ...
          'descriptor': {shape: [2, 'C', 2, 2], dataType: 'float16'},
          'shape': [2, 3, 2, 2]
        }
      },
      'operators': [{
      ...
      'expectedOutputs': {
        'instanceNormOutput': {
          'data': [
            -1.099609375, 1.552734375,  -0.599609375, 0.14599609375,
            1.72265625,   -0.41015625,  -0.724609375, -0.5869140625,
            0.130859375,  -1.6640625,   0.91015625,   0.62109375,
            0.794921875,  1.130859375,  -1.30664062,  -0.619140625,
            0.265625,     0.94609375,   -1.6796875,   0.466796875,
            1.5039062,    -1.298828125, -0.23046875,  0.0247039794
          ],
          'descriptor': {shape: [2, 'C', 2, 2], dataType: 'float16'},
          'shape': [2, 3, 2, 2]
        }
  ...
  {
    'name':
        'instanceNormalization float32 4D tensor with dynamic channel dimension nhwc layout',
    'graph': {
      'inputs': {
        'instanceNormInput': {
          'data': [
            ...
            -73.92131042480469, -74.66901397705078, 54.42462158203125,
            -38.11185836791992, -68.16508483886719, 47.53074645996094,
            66.93562316894531,  37.37651062011719,  -16.574905395507812,
            76.74034881591797,  56.252689361572266, 42.949893951416016,
            5.6758809089660645, -99.00035095214844, 73.8739242553711,
            25.68659210205078,  -33.11322784423828, -17.380685806274414
          ],
          'descriptor': {shape: [2, 2, 2, 'C'], dataType: 'float32'},
          'shape': [2, 2, 2, 3]
        }
      },
      'operators': [{
      ...
      'expectedOutputs': {
        'instanceNormOutput': {
          'data': [
            -1.0995290279388428, 1.72129487991333,     0.13073232769966125,
            1.5525833368301392,  -0.41020718216896057, -1.6633318662643433,
            -0.5992818474769592, -0.7240943908691406,  0.9108772277832031,
            0.14622755348682404, -0.586993396282196,   0.6217225193977356,
            0.7947131395339966,  0.765209436416626,    -0.9501267671585083,
            1.13092041015625,    1.0725492238998413,   0.5664495229721069,
            -1.3059039115905762, -1.455262541770935,   1.354333758354187,
            -0.6197299361228943, -0.3824961185455322,  -0.9706565737724304
          ],
          'descriptor': {shape: [2, 2, 2, 'C'], dataType: 'float32'},
          'shape': [2, 2, 2, 3]
        }
