...
if (navigator.ml !== undefined) {
  promise_test(async () => {
    ...
    const a = builder.input('a', {dataType: 'float32', shape: ['batch', 2]});
  ...
  promise_test(async () => {
    ...
    const a = builder.input('a', {dataType: 'float32', shape: ['N']});
  ...
  promise_test(async () => {
    ...
    const a = builder.input(
        'a', {dataType: 'float32', shape: [1, 'sequence_length']});
    const b = builder.input(
        'b', {dataType: 'float32', shape: ['sequence_length', 1]});
  ...
  promise_test(async () => {
    ...
    const a = builder.input(
        'a', {dataType: 'float32', shape: [1, 'sequence_length']});
    const b = builder.input(
        'b', {dataType: 'float32', shape: [1, 'past_sequence_length']});
    const c = builder.input(
        'c', {dataType: 'float32', shape: ['sequence_length', 1]});
    const d = builder.input(
        'd', {dataType: 'float32', shape: ['past_sequence_length', 1]});
