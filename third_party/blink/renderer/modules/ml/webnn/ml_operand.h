...
class MLOperator;
class V8UnionStringOrUnsignedLongEnforceRange;

typedef V8UnionStringOrUnsignedLongEnforceRange MLDimension;
// A "?" string element represents an unnamed dynamic dimension (ORT's `?`).
